 ...
 */
if ( !class_exists( 'CBXWPSlack_Settings_API' ) ):
class CBXWPSlack_Settings_API {
    ...
    function show_forms() {
        ...
        <div class="metabox-holder">
			<?php foreach ( $this->settings_sections as $form ) { ?>
				<div id="<?php echo $form['id']; ?>" class="cbxwpslack_group" style="display: none;">
					<form method="post" action="options.php">
						<?php
						do_action( 'cbxwpslack_form_top_' . $form['id'], $form );
						settings_fields( $form['id'] );
						do_settings_sections( $form['id'] );
						do_action( 'cbxwpslack_form_bottom_' . $form['id'], $form );
						?>
